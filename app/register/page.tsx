...
const Register = async () => {
  ...
  return (
    <div
      className=' mt-10 max-w-md w-full mx-auto rounded-md md:rounded-2xl p-4 md:p-8 shadow-input bg-white border border-[#121212] dark:bg-black'
    >
      <h2 className='font-bold text-xl text-neutral-800 dark:text-neutral-200 '>Welcome to MY Shop</h2>
      <p className='text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300'>
        Please Provide All The Necessary Onformation
      </p>
      ...
      <form action={register} className="my-8">
        ...
        <Input id='email' placeholder='ProjectMayhesa@fc.com' type='email' name='email' />
